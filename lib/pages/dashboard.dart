...
class Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const Color primaryColor = Color.fromARGB(255, 24, 0, 129);   // Ganti dengan warna 'primary' Anda
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        begin: Alignment.bottomCenter, // Mulai dari bawah (to-t)
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 20,
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 43, 85, 255),
                                borderRadius: BorderRadius.circular(50)
                              ),
                            ),
                            SizedBox(width: 10),
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 20,
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 109, 138, 255),
                                borderRadius: BorderRadius.circular(50)
                              ),
                            ),
                            SizedBox(width: 10),
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 20,
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 173, 190, 255),
                                borderRadius: BorderRadius.circular(50)
                              ),
                            ),
                            SizedBox(width: 10),
